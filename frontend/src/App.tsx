    ...
    const fetchNewsData = async () => {
      try {
        ...
        const newsResponse = await ai.models.generateContent({
          ...
          contents: 'Generate a list of 4 real estate news articles relevant to the Massachusetts market, relevant to the current market and within the last 30 days (it is currently August 2025).',
          config: {
